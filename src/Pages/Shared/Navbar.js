...
const Navbar = () => {
  ...
  const logout = () => {
   ...
   <li>
     {
       user? <>
       <span className='uppercase text-primary mr-[-20px]'>{user?.displayName}</span> 
       <button onClick={logout} className='btn btn-link font-bold text-secondary no-underline'>SIGNOUT</button>
